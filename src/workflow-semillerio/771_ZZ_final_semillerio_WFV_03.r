...
# Necesita para correr en Google Cloud x
...
PARAM <- list()
PARAM$experimento <- "ZZ7710_WFV_03"
PARAM$exp_input <- "HT7510_WFV_03"
...
primos <- generate_primes(min = 100000, max = 900000)
